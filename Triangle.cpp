...
void Triangle::initWindow()
{
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan Triangle Demo", nullptr, nullptr);
...
void Triangle::initVulkan()
{
    ...
    std::cout << "createColorResources" << std::endl;
...
void Triangle::createLogicDevice()
{
...
{
    auto vertShaderCode = SpvLoader::readFile("../shaders/vert.spv");
    auto fragShaderCode = SpvLoader::readFile("../shaders/frag.spv");
...
void Triangle::createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkSampleCountFlagBits numSamples, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage &image, VkDeviceMemory &imageMemory)
{
...
void Triangle::createTextureSampler()
{
    ...
    std::cout << "max Anisotropy: " << properties.limits.maxSamplerAnisotropy << std::endl;
...
void Triangle::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, VkImageAspectFlags aspect, uint32_t mipLevels)
{
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
VkSurfaceFormatKHR Triangle::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR> &availableFormats)
{
    ...
    std::cout << "fall back to the first available surface format!" << std::endl;
